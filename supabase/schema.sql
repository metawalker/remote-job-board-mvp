...
-- MIGRATION: If you have an existing database, run this ALTER statement:
-- ALTER TABLE jobs ADD COLUMN apply_url TEXT CHECK (apply_url ~ '^https?://[^\s/$.?#].[^\s]*$');
...
CREATE TABLE jobs (
    ...
    skills TEXT[] DEFAULT '{}',
    apply_url TEXT CHECK (apply_url ~ '^https?://[^\s/$.?#].[^\s]*$'),
...
INSERT INTO jobs (company_id, title, description, location, salary_min, salary_max, employment_type, remote_type, skills, apply_url, is_active) VALUES
(
    ...
    'https://techcorp.com/careers/senior-frontend-developer',
    true
),
(
    ...
    'https://designstudio.com/apply/ui-ux-designer',
    true
),
(
...
(
    ...
    'https://cloudfirst.com/careers/devops-engineer',
    true
);
